...
class DapSyntheticPauseGate(
     ...
     *
     * A stopped event that explicitly reports [hitBreakpointIds] is a
     * real breakpoint stop, not a pause acknowledgement. Let it reach
     * the IDE and leave the inferior stopped.
     */
